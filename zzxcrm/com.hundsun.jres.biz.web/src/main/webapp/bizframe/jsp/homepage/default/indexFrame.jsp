<!-- 修改记录
2013-05-30   zhangsu   BUG #4256 使用ie7，biz登录，刷新当前页面，退出了   去掉了body标签中的事件
 -->
...
%>
   ...
   <%}
  session.setAttribute(SessionConstants.ARRT_CURR_USER_HOMEPAGE,"bizframe/jsp/homepage/default/indexFrame.jsp?resCode=bizSign&opCode=bizSignIn");
...
<!-- BUG #4256 body onbeforeunload="closeWindow();"  去掉这个事件-->
<body>
<div id="main-div">
</div>
