...
public class AuthorityConstants {	
	...
	public static final String SYS_SUPER_USER=SysParameterUtil.getProperty("systemUser", "admin");
	
	public static final String SYS_SUPER_ROLE=SysParameterUtil.getProperty("systemRole", "admin");
	
	//---20111102-----huhl@hundsun.com----登录可用别的字段登录----begin ----
	/**登录获取用户字段 */
	public static final String SYS_LOGIN_FIELD_NAME=SysParameterUtil.getProperty("loginFieldName", "user_id");
