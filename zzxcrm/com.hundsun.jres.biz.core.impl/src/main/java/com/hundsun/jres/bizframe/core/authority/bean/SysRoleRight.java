...
public class SysRoleRight extends AbstractRight implements Serializable{
	/**
	 * 
	 */
	private static final long serialVersionUID = -8116210596806549820L;
	...
	public String getTargetCate() {
		return AuthorityConstants.TYPE_RIGHT_CATE_ROLE;
	}
	@Override
