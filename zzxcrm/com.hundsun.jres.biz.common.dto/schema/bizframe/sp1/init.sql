--新增版本信息
delete from jres_subsystem_rc where subsystem_name='bizframe' and subsystem_ver='1.0.3.3';
insert into jres_subsystem_rc (subsystem_name, subsystem_ver,begin_time, remark)
values('bizframe', '1.0.3.3',sysdate, '新建基础业务框架V1.0.3.3版');
...
insert into tsys_trans (trans_code,trans_name,kind_code,model_code,remark) values ('bizSetBranch','机构设置','BIZFRAME','2','');
...
insert into tsys_trans (trans_code,trans_name,kind_code,model_code,remark) values ('bizSetRight','权限设置','BIZFRAME','2','');
...
insert into tsys_trans (trans_code,trans_name,kind_code,model_code,remark) values ('bizSetSubTrans','子交易设置','BIZFRAME','1','');
...
insert into tsys_trans (trans_code,trans_name,kind_code,model_code,remark) values ('bizPageCacheSet','页面缓存设置','BIZFRAME','1','');
insert into tsys_trans (trans_code,trans_name,kind_code,model_code,remark) values ('bizSysMenu','系统菜单','BIZFRAME','1','');
insert into tsys_trans (trans_code,trans_name,kind_code,model_code,remark) values ('BIZFRAME','基础业务框架','BIZFRAME','1','');
insert into tsys_trans (trans_code,trans_name,kind_code,model_code,remark) values ('bizMonitorMenu','系统平台管理菜单','BIZFRAME','1','');
insert into tsys_trans (trans_code,trans_name,kind_code,model_code,remark) values ('bizOnlineMonitor','系统平台管理菜单','BIZFRAME','1','');
insert into tsys_trans (trans_code,trans_name,kind_code,model_code,remark) values ('bizMsg','消息管理菜单','BIZFRAME','1','');
insert into tsys_trans (trans_code,trans_name,kind_code,model_code,remark) values ('bizEmailOutbox','发件箱菜单','BIZFRAME','1','');
...
insert into tsys_subtrans (trans_code,sub_trans_code,rel_serv,rel_url,ctrl_flag,login_flag,remark,ext_field_1,ext_field_2,ext_field_3,sub_trans_name) values ('bizSetBranch','bizOfficeFind2','bizframe.authority.organization.findOfficeByDep','','','0','','','','','岗位查找');
...
--消息管理子交易
insert into tsys_subtrans (trans_code,sub_trans_code,rel_serv,rel_url,ctrl_flag,login_flag,remark,ext_field_1,ext_field_2,ext_field_3,sub_trans_name) values ('bizMsg','bizMsg','','','0','1','','','','','消息管理菜单');
...
--系统一级菜单
insert into tsys_menu (menu_code,kind_code,trans_code,sub_trans_code,menu_name,menu_arg,menu_icon,menu_url,window_type,tip,hot_key,parent_code,order_no,open_flag,tree_idx,remark) values ('bizMenu','BIZFRAME','bizSysMenu','bizSysMenu','系统菜单','','bizframe/images/bizMenu.png','','0','','','BIZFRAME',0,'','#bizroot#BIZFRAME#bizMenu#','');
--系统二级菜单(用户管理模块)
...
insert into tsys_menu (menu_code,kind_code,trans_code,sub_trans_code,menu_name,menu_arg,menu_icon,menu_url,window_type,tip,hot_key,parent_code,order_no,open_flag,tree_idx,remark) values ('bizSetCache','BIZFRAME','bizSetCache','bizCacheFresh','系统缓存设置','','bizframe/images/bizSetCache.png','bizframe/common/cacheFresh.mw','0','','','bizSysManager',4,'1','#bizroot#BIZFRAME#bizMenu#bizSysManager#bizSetCache#','');
...
insert into tsys_menu (menu_code,kind_code,trans_code,sub_trans_code,menu_name,menu_arg,menu_icon,menu_url,window_type,tip,hot_key,parent_code,order_no,open_flag,tree_idx,remark) values ('bizPageCacheSet','BIZFRAME','bizPageCacheSet','pageCacheSet','页面缓存设置','','bizframe/images/bizPageCache.png','bizframe/cacheRefresh/refreshPage.mw','0','','','bizSysManager',6,'','#bizroot#BIZFRAME#bizMenu#bizSysManager#bizPageCacheSet#','');

--系统二级菜单(消息管理模块)
insert into tsys_menu (menu_code,kind_code,trans_code,sub_trans_code,menu_name,menu_arg,menu_icon,menu_url,window_type,tip,hot_key,parent_code,order_no,open_flag,tree_idx,remark) values ('bizMsgManager','BIZFRAME','bizMsg','bizMsg','消息管理','','bizframe/images/bizEmailManager.png','','0','','','bizMenu',3,'','#bizroot#BIZFRAME#bizMenu#bizMsgManager#','');
...
insert into tsys_parameter (param_code,rel_org,kind_code,param_name,param_value,lifecycle,platform,ext_flag,param_desc) values ('passUnit','000000','BIZ_PARAM','密码有效时间单位','2','','','','');
insert into tsys_parameter (param_code,rel_org,kind_code,param_name,param_value,lifecycle,platform,ext_flag,param_desc) values ('passValidity','000000','BIZ_PARAM','密码有效周期','2','','','','');
...
where subsystem_name='bizframe' and  subsystem_ver='1.0.3.3';
