...
alter table tsys_user
   drop constraint fk_org_user;

   
alter table tsys_org_user
   drop constraint fk_userid_orguser;
...
drop table tsys_organization cascade constraints;

drop table tsys_org_user cascade constraints;

drop table tsys_position cascade constraints;

drop table tsys_pos_user cascade constraints;
