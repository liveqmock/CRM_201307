...
--系统参数初始化
insert into tsys_parameter (param_code,rel_org,kind_code,param_name,param_value,lifecycle,platform,ext_flag,param_desc,param_regex) values ('desktopBg','0_000000','BIZ_PARAM','桌面背景','desktopBg.gif','','','','','');
insert into tsys_parameter (param_code,rel_org,kind_code,param_name,param_value,lifecycle,platform,ext_flag,param_desc,param_regex) values  ('desktopLogo','0_000000','BIZ_PARAM','桌面LOGO','desktopLogo.gif','','','','','');
insert into tsys_parameter (param_code,rel_org,kind_code,param_name,param_value,lifecycle,platform,ext_flag,param_desc,param_regex) values  ('defaultLogo','0_000000','BIZ_PARAM','默认主页LOGO','logo.png','','','','','');
insert into tsys_parameter (param_code,rel_org,kind_code,param_name,param_value,lifecycle,platform,ext_flag,param_desc,param_regex) values  ('loginBg','0_000000','BIZ_PARAM','登陆页面背景','login_logo.png','','','','','');
insert into tsys_parameter (param_code,rel_org,kind_code,param_name,param_value,lifecycle,platform,ext_flag,param_desc,param_regex) values  ('passUnit','0_000000','BIZ_PARAM','密码有效时间单位','2','','','','0代表天，1代表周，2代表月，3代表年','^[0-3]$');
insert into tsys_parameter (param_code,rel_org,kind_code,param_name,param_value,lifecycle,platform,ext_flag,param_desc,param_regex) values  ('passValidity','0_000000','BIZ_PARAM','密码有效周期','2','','','','数值，表示指定数量个密码有效单位的时间长度','^[1-9]d*$');
insert into tsys_parameter (param_code,rel_org,kind_code,param_name,param_value,lifecycle,platform,ext_flag,param_desc,param_regex) values  ('maxWrongPass','0_000000','BIZ_PARAM','最大允许密码错误次数','10','','','','数值，表示大允许密码错误次数','^[1-9]d*$');
insert into tsys_parameter (param_code,rel_org,kind_code,param_name,param_value,lifecycle,platform,ext_flag,param_desc,param_regex) values  ('defaultUserPassword','0_000000','BIZ_PARAM','默认密码','111111','','','1','系统用户默认密码','');
insert into tsys_parameter (param_code,rel_org,kind_code,param_name,param_value,lifecycle,platform,ext_flag,param_desc,param_regex) values  ('shieldF5','0_000000','BIZ_PARAM','屏蔽F5按钮','true','','','1','布尔值，页面是否需屏蔽F5按钮,true代表屏蔽false代表不屏蔽','^true|false$');
insert into tsys_parameter (param_code,rel_org,kind_code,param_name,param_value,lifecycle,platform,ext_flag,param_desc,param_regex) values  ('shieldBcakSpace','0_000000','BIZ_PARAM','屏蔽鼠标右键','true','','','1','布尔值，页面是否需屏蔽鼠标右键,true代表屏蔽false代表不屏蔽','^true|false$');
insert into tsys_parameter (param_code,rel_org,kind_code,param_name,param_value,lifecycle,platform,ext_flag,param_desc,param_regex) values  ('default_menu_depth','0_000000','BIZ_PARAM','默认主页菜单深度','1','','','1','数值，代表默认主页菜单深度','^[1-9]d*$');
insert into tsys_parameter (param_code,rel_org,kind_code,param_name,param_value,lifecycle,platform,ext_flag,param_desc,param_regex) values  ('desktop_start_menu_depth','0_000000','BIZ_PARAM','桌面开始菜单深度','1','','','1','数值，代表桌面开始菜单深度','^[1-9]d*$');
insert into tsys_parameter (param_code,rel_org,kind_code,param_name,param_value,lifecycle,platform,ext_flag,param_desc,param_regex) values  ('desktop_navigation_menu_depth','0_000000','BIZ_PARAM','桌面顶置导航菜单深度','1','','','1','数值，代表桌面顶置导航菜单深度','^[1-9]d*$');
insert into tsys_parameter (param_code,rel_org,kind_code,param_name,param_value,lifecycle,platform,ext_flag,param_desc,param_regex) values  ('openMaxTabNum','0_000000','BIZ_PARAM','最大菜单数目','6','','','1','数值，代表主页打开的最大菜单数目','^[1-9]d*$');
insert into tsys_parameter (param_code,rel_org,kind_code,param_name,param_value,lifecycle,platform,ext_flag,param_desc,param_regex) values  ('login_has_validateCode','0_000000','BIZ_PARAM','登陆需验证码','false','','','1','布尔值，代表登陆需验证码,true代表需要false代表不需要','^true|false$');
insert into tsys_parameter (param_code,rel_org,kind_code,param_name,param_value,lifecycle,platform,ext_flag,param_desc,param_regex) values  ('systemHelpUrl','0_000000','BIZ_PARAM','系统帮助手册地址','bizframe/jsp/help/bizframe-help.html','','','1','字符串，代表系统帮助手册地址','');
insert into tsys_parameter (param_code,rel_org,kind_code,param_name,param_value,lifecycle,platform,ext_flag,param_desc,param_regex) values  ('logoHeight','0_000000','BIZ_PARAM','logo高度','70','','','1','数值，代表页面logo区域高度，默认值70','^[1-9]d*$');
insert into tsys_parameter (param_code,rel_org,kind_code,param_name,param_value,lifecycle,platform,ext_flag,param_desc,param_regex) values  ('singleTab','0_000000','BIZ_PARAM','单一打开菜单','true','','','1','布尔值，页面是否单一打开菜单,true代表单一打开 false代表多窗口打开','^true|false$');
insert into tsys_parameter (param_code,rel_org,kind_code,param_name,param_value,lifecycle,platform,ext_flag,param_desc,param_regex) values  ('menuLoadModel','0_000000','BIZ_PARAM','首页菜单加载模式','tree','','','1','字符串，代表首页菜单加载模式，目前只支持accordion和tree两种模式','^accordion|tree$');
insert into tsys_parameter (param_code,rel_org,kind_code,param_name,param_value,lifecycle,platform,ext_flag,param_desc,param_regex) values  ('commonPositionNameSuffix','0_000000','BIZ_PARAM','普通岗位名称后缀','普通岗','','','1','字符串，代表新增组织的普通岗位名称后缀','');
insert into tsys_parameter (param_code,rel_org,kind_code,param_name,param_value,lifecycle,platform,ext_flag,param_desc,param_regex) values  ('commonPositionCodeSuffix','0_000000','BIZ_PARAM','普通岗位编号后缀','common','','','1','字符串，代表新增组织的普通岗位编号后缀','');
insert into tsys_parameter (param_code,rel_org,kind_code,param_name,param_value,lifecycle,platform,ext_flag,param_desc,param_regex) values  ('managerPositionNameSuffix','0_000000','BIZ_PARAM','负责岗位名称后缀','主管岗','','','1','字符串，代表新增组织的负责岗位名称后缀','');
insert into tsys_parameter (param_code,rel_org,kind_code,param_name,param_value,lifecycle,platform,ext_flag,param_desc,param_regex) values  ('managerPositionCodeSuffix','0_000000','BIZ_PARAM','负责岗位编号后缀','head','','','1','字符串，代表新增组织的负责岗位编号后缀','');
insert into tsys_parameter (param_code,rel_org,kind_code,param_name,param_value,lifecycle,platform,ext_flag,param_desc,param_regex) values  ('lockScreenInterval','0_000000','BIZ_PARAM','锁屏时间隔','10','','','1','数值，代表用户无活动锁屏时间隔(以分钟为单位，默认10分钟)','^[1-9]d*$');
insert into tsys_parameter (param_code,rel_org,kind_code,param_name,param_value,lifecycle,platform,ext_flag,param_desc,param_regex) values  ('msgPollInterval','0_000000','BIZ_PARAM','消息轮询间隔','3','','','1','数值，代表页面消息轮询间隔(以分钟为单位，默认3分钟)','^[1-9]d*$');
insert into tsys_parameter (param_code,rel_org,kind_code,param_name,param_value,lifecycle,platform,ext_flag,param_desc,param_regex) values  ('cacheRefeshInterval','0_000000','BIZ_PARAM','缓存刷新间隔','60','','','1','数值，代表缓存刷新的时间间隔(以秒为单位，默认60秒)','^[1-9]d*$');
...
insert into tsys_subtrans (trans_code,sub_trans_code,rel_serv,rel_url,ctrl_flag,login_flag,remark,ext_field_1,ext_field_2,ext_field_3,sub_trans_name) values ('bizSetUser','userOpMenuFind','bizframe.authority.user.userOpMenuFind','','1','1','','','','','用户操作菜单权限查询');
...
insert into tsys_user_right (trans_code,sub_trans_code,user_id,create_by,create_date,begin_date,end_date,right_flag) values ('bizSetUser','userOpMenuFind','admin','admin',0,0,0,'1');
insert into tsys_user_right (trans_code,sub_trans_code,user_id,create_by,create_date,begin_date,end_date,right_flag) values ('bizSetUser','userOpMenuFind','admin','admin',0,0,0,'2');
