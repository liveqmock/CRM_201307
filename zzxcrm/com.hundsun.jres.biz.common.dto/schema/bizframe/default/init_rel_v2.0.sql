...
insert into tsys_trans (trans_code,trans_name,kind_code,model_code,remark) values ('bizVersionInfo','版本信息','BIZFRAME','','');
...
where subsystem_name='bizframe' and  subsystem_ver='2.0.0';
commit;