...
commit;
insert into tsys_branch (branch_code,branch_level,branch_name,short_name,parent_code,branch_path,remark,ext_field_1,ext_field_2,ext_field_3) values ('00000010','1','公司总部','总部','bizroot','11','','','','');
insert into tsys_branch (branch_code,branch_level,branch_name,short_name,parent_code,branch_path,remark,ext_field_1,ext_field_2,ext_field_3) values ('00000011','2','公司研发中心','研发','00000010','1101','','','','');
insert into tsys_branch (branch_code,branch_level,branch_name,short_name,parent_code,branch_path,remark,ext_field_1,ext_field_2,ext_field_3) values ('00000012','4','金融部','金融','00000010','1102','','','','');
insert into tsys_branch (branch_code,branch_level,branch_name,short_name,parent_code,branch_path,remark,ext_field_1,ext_field_2,ext_field_3) values ('00000013','3','金融研发中心','金融研发','00000011','110101','','','','');
commit;
insert into tsys_dep (dep_code, dep_name, short_name, parent_code, branch_code, remark, ext_field_1, ext_field_2, ext_field_3, dep_path) values ('00000010', '部门根结点', '根结点', 'bizroot', '00000010', null, null, null, null, '11');
insert into tsys_dep (dep_code, dep_name, short_name, parent_code, branch_code, remark, ext_field_1, ext_field_2, ext_field_3, dep_path) values ('00000011', '研发部ARES', 'ARES', '00000010', '00000011', null, null, null, null, '1101');
insert into tsys_dep (dep_code, dep_name, short_name, parent_code, branch_code, remark, ext_field_1, ext_field_2, ext_field_3, dep_path) values ('00000012', '研发部JRES', 'JRES', '00000011', '00000011', null, null, null, null, '110101');
insert into tsys_dep (dep_code, dep_name, short_name, parent_code, branch_code, remark, ext_field_1, ext_field_2, ext_field_3, dep_path) values ('00000013', '研发部SEE', 'SEE', '00000011', '00000011', null, null, null, null, '110102');
insert into tsys_dep (dep_code, dep_name, short_name, parent_code, branch_code, remark, ext_field_1, ext_field_2, ext_field_3, dep_path) values ('00000021', '金融部综合理财', '金融理财', '00000010', '00000013', null, null, null, null, '1102');
commit;
insert into tsys_role (role_code, role_name, creator, remark) values ('admin', '系统管理员角色', 'admin', null);
commit;
insert into tsys_office (office_code, office_name, short_name, parent_code, branch_code, dep_code, remark, ext_field_1, ext_field_2, ext_field_3, office_path) values ('00000010', '岗位根结点', '根结点', 'bizroot', '00000010', '00000010', null, null, null, null, '11');
insert into tsys_office (office_code, office_name, short_name, parent_code, branch_code, dep_code, remark, ext_field_1, ext_field_2, ext_field_3, office_path) values ('00000011', '部门经理', '部门经理', '00000010', '00000011', '00000011', null, null, null, null, '1101');
insert into tsys_office (office_code, office_name, short_name, parent_code, branch_code, dep_code, remark, ext_field_1, ext_field_2, ext_field_3, office_path) values ('00000012', '项目经理', '项目经理', '00000010', '00000011', '00000012', null, null, null, null, '1102');
insert into tsys_office (office_code, office_name, short_name, parent_code, branch_code, dep_code, remark, ext_field_1, ext_field_2, ext_field_3, office_path) values ('00000013', '开发人员', '开发人员', '00000010', '00000010', '00000012', null, null, null, null, '1103');
commit;
insert into tsys_user (user_id,branch_code,dep_code,user_name,user_pwd,user_type,user_status,lock_status,create_date,modify_date,pass_modify_date,remark,ext_field_1,ext_field_2,ext_field_3,ext_field_4,ext_field_5) values ('admin','00000013','00000010','系统管理员','4c46f2e1706c97ad404393fa22560b3b','0','0','0',20101118,20101118,20101118,'','','','','','');
insert into tsys_user (user_id, branch_code, dep_code, user_name, user_pwd, user_type, user_status, lock_status, create_date, modify_date, pass_modify_date, remark, ext_field_1, ext_field_2, ext_field_3, ext_field_4, ext_field_5) values ('111111', '00000011', '00000010', '同步授权测试帐号', 'd6a5b22c801a252a74522198a8b6e3a8', '0', '0', '0', 20100914, 20100914, 20100914, null, null, null, null, null, null);
commit;
...
insert into tsys_kind (kind_code,kind_type,kind_name,parent_code,mnemonic,tree_idx,remark) values ('0006','5','子系统','bizroot','4','#bizroot#0006#','');
...
insert into tsys_subtrans (trans_code,sub_trans_code,rel_serv,rel_url,ctrl_flag,login_flag,remark,ext_field_1,ext_field_2,ext_field_3,sub_trans_name) values ('bizSetParam','bizSetParamEdit','','','1','1','','','','','参数增加');
insert into tsys_subtrans (trans_code,sub_trans_code,rel_serv,rel_url,ctrl_flag,login_flag,remark,ext_field_1,ext_field_2,ext_field_3,sub_trans_name) values ('bizSetParam','bizSetParamDlt','','','1','1','','','','','参数增加');
...
insert into tsys_subtrans (trans_code,sub_trans_code,rel_serv,rel_url,ctrl_flag,login_flag,remark,ext_field_1,ext_field_2,ext_field_3,sub_trans_name) values ('bizTrancTest','bizTrancTest0001','bizTrancTest','bizTrancTestbizTrancTest','1','1','bizTrancTest','','','','交易新增');
insert into tsys_subtrans (trans_code,sub_trans_code,rel_serv,rel_url,ctrl_flag,login_flag,remark,ext_field_1,ext_field_2,ext_field_3,sub_trans_name) values ('bizTrancTest','bizTrancTest0002','bizTrancTes','bizTrancTest','1','1','bizTrancTest0002','','','','交易删除');
...
insert into tsys_menu (menu_code,kind_code,trans_code,sub_trans_code,menu_name,menu_arg,menu_icon,window_type,tip,hot_key,parent_code,order_no,open_flag,tree_idx,remark) values ('bizKernelStatus','BIZFRAME','bizSysStatus','bizKernelStatus','执行框架状态信息','','','0','','','bizSysStatus',0,'','#bizroot#BIZFRAME#bizMenu#bizMonitorMenu#bizOnlineMonitor#bizSysStatus#bizKernelStatus#','');
...
insert into tsys_menu (menu_code,kind_code,trans_code,sub_trans_code,menu_name,menu_arg,menu_icon,window_type,tip,hot_key,parent_code,order_no,open_flag,tree_idx,remark) values ('bizWarning','BIZFRAME','bizMenu','bizMenu','异常告警','','images/bizframe/bizWarning.png','','','','bizOnlineMonitor',0,'','#bizroot#BIZFRAME#bizMenu#bizMonitorMenu#bizOnlineMonitor#bizWarning#','');
...
insert into tsys_menu (menu_code,kind_code,trans_code,sub_trans_code,menu_name,menu_arg,menu_icon,window_type,tip,hot_key,parent_code,order_no,open_flag,tree_idx,remark) values ('bizCEPStatus','BIZFRAME','bizSysStatus','bizCEPStatus','CEP及其插件状态信息','','','0','','','bizSysStatus',1,'','#bizroot#BIZFRAME#bizMenu#bizMonitorMenu#bizOnlineMonitor#bizSysStatus#bizCEPStatus#','');
insert into tsys_menu (menu_code,kind_code,trans_code,sub_trans_code,menu_name,menu_arg,menu_icon,window_type,tip,hot_key,parent_code,order_no,open_flag,tree_idx,remark) values ('bizPlugContainer','BIZFRAME','bizVersionInfo','bizPlugContainer','插件容器','','','0','','','bizVersion',1,'','#bizroot#BIZFRAME#bizMenu#bizMonitorMenu#bizOnlineMonitor#bizVersion#bizPlugContainer#','');
insert into tsys_menu (menu_code,kind_code,trans_code,sub_trans_code,menu_name,menu_arg,menu_icon,window_type,tip,hot_key,parent_code,order_no,open_flag,tree_idx,remark) values ('bizOpRunning','BIZFRAME','bizMenu','bizMenu','业务运行信息','','','','','','bizOnlineMonitor',1,'','#bizroot#BIZFRAME#bizMenu#bizMonitorMenu#bizOnlineMonitor#bizOpRunning#','');
...
insert into tsys_menu (menu_code,kind_code,trans_code,sub_trans_code,menu_name,menu_arg,menu_icon,window_type,tip,hot_key,parent_code,order_no,open_flag,tree_idx,remark) values ('bizSysConfig','BIZFRAME','bizMenu','bizMenu','系统配置','','images/bizframe/bizSysConfig.png','','','','bizMonitorMenu',1,'','#bizroot#BIZFRAME#bizMenu#bizMonitorMenu#bizSysConfig#','');
insert into tsys_menu (menu_code,kind_code,trans_code,sub_trans_code,menu_name,menu_arg,menu_icon,window_type,tip,hot_key,parent_code,order_no,open_flag,tree_idx,remark) values ('bizSysStatus','BIZFRAME','bizMenu','bizMenu','系统状态信息','','images/bizframe/bizSysStatus.png','','','','bizOnlineMonitor',2,'','#bizroot#BIZFRAME#bizMenu#bizMonitorMenu#bizOnlineMonitor#bizSysStatus#','');
insert into tsys_menu (menu_code,kind_code,trans_code,sub_trans_code,menu_name,menu_arg,menu_icon,window_type,tip,hot_key,parent_code,order_no,open_flag,tree_idx,remark) values ('bizCEP','BIZFRAME','bizVersionInfo','bizCEP','CEP及其插件','','','0','','','bizVersion',2,'','#bizroot#BIZFRAME#bizMenu#bizMonitorMenu#bizOnlineMonitor#bizVersion#bizCEP#','');
insert into tsys_menu (menu_code,kind_code,trans_code,sub_trans_code,menu_name,menu_arg,menu_icon,window_type,tip,hot_key,parent_code,order_no,open_flag,tree_idx,remark) values ('bizCacheStatus','BIZFRAME','bizSysStatus','bizCacheStatus','缓存状态信息','','','0','','','bizSysStatus',2,'','#bizroot#BIZFRAME#bizMenu#bizMonitorMenu#bizOnlineMonitor#bizSysStatus#bizCacheStatus#','');
insert into tsys_menu (menu_code,kind_code,trans_code,sub_trans_code,menu_name,menu_arg,menu_icon,window_type,tip,hot_key,parent_code,order_no,open_flag,tree_idx,remark) values ('bizAppDeploy','BIZFRAME','bizMenu','bizMenu','应用部署','','images/bizframe/bizAppDeploy.png','','','','bizMonitorMenu',2,'','#bizroot#BIZFRAME#bizMenu#bizMonitorMenu#bizAppDeploy#','');
...
insert into tsys_menu (menu_code,kind_code,trans_code,sub_trans_code,menu_name,menu_arg,menu_icon,window_type,tip,hot_key,parent_code,order_no,open_flag,tree_idx,remark) values ('bizDBStatus','BIZFRAME','bizSysStatus','bizDBStatus','数据库状态信息','','','0','','','bizSysStatus',3,'','#bizroot#BIZFRAME#bizMenu#bizMonitorMenu#bizOnlineMonitor#bizSysStatus#bizDBStatus#','');
insert into tsys_menu (menu_code,kind_code,trans_code,sub_trans_code,menu_name,menu_arg,menu_icon,window_type,tip,hot_key,parent_code,order_no,open_flag,tree_idx,remark) values ('bizColony','BIZFRAME','bizMenu','bizMenu','集群管理','','images/bizframe/bizColony.png','','','','bizMonitorMenu',3,'','#bizroot#BIZFRAME#bizMenu#bizMonitorMenu#bizColony#','');
insert into tsys_menu (menu_code,kind_code,trans_code,sub_trans_code,menu_name,menu_arg,menu_icon,window_type,tip,hot_key,parent_code,order_no,open_flag,tree_idx,remark) values ('bizVersion','BIZFRAME','bizMenu','bizMenu','版本信息','','images/bizframe/bizVersion.png','','','','bizOnlineMonitor',3,'','#bizroot#BIZFRAME#bizMenu#bizMonitorMenu#bizOnlineMonitor#bizVersion#','');
...
insert into tsys_menu (menu_code,kind_code,trans_code,sub_trans_code,menu_name,menu_arg,menu_icon,window_type,tip,hot_key,parent_code,order_no,open_flag,tree_idx,remark) values ('bizUIStatus','BIZFRAME','bizSysStatus','bizUIStatus','UIEngine状态信息','','','0','','','bizSysStatus',4,'','#bizroot#BIZFRAME#bizMenu#bizMonitorMenu#bizOnlineMonitor#bizSysStatus#bizUIStatus#','');
...
commit;
insert into tsys_parameter (param_code,rel_org,kind_code,param_name,param_value) values ('desktopBg','00000010','BIZ_PARAM','桌面背景','desktopBg.gif');
insert into tsys_parameter (param_code,rel_org,kind_code,param_name,param_value) values ('desktopLogo','00000010','BIZ_PARAM','桌面LOGO','desktopLogo.png');
insert into tsys_parameter (param_code,rel_org,kind_code,param_name,param_value) values ('defaultLogo','00000010','BIZ_PARAM','默认主页LOGO','logo.png');
insert into tsys_parameter (param_code,rel_org,kind_code,param_name,param_value) values ('loginBg','00000010','BIZ_PARAM','登陆页面背景','login_logo.png');
insert into tsys_parameter (param_code,rel_org,kind_code,param_name,param_value) values ('passUnit','00000010','BIZ_PARAM','密码有效时间单位','2');
insert into tsys_parameter (param_code,rel_org,kind_code,param_name,param_value) values ('passValidity','00000010','BIZ_PARAM','密码有效周期','2');
insert into tsys_parameter (param_code,rel_org,kind_code,param_name,param_value) values ('maxWrongPass','00000010','BIZ_PARAM','最大允许密码错误次数','10');
...
insert into tsys_parameter (param_code,rel_org,kind_code,param_name,param_value) values ('welcomeUrl','00000010','BIZ_PARAM','默认主页地址','http://www.hundsun.com');
commit;
...
insert into tsys_user_right (trans_code,sub_trans_code,user_id,create_by,create_date,begin_date,end_date,right_flag) values ('bizTrancTest','bizTrancTest0001','admin','admin',0,0,0,'1');
...
insert into tsys_user_right (trans_code,sub_trans_code,user_id,create_by,create_date,begin_date,end_date,right_flag) values ('bizTrancTest','bizTrancTest0002','admin','admin',0,0,0,'1');
